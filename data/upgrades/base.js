...
const simpleUpgrades = [
    ...
    ['N-leaf clover', 'lucky-clover', 'A clover with an unusual number of leaves. Will bring food luck!', {[Resources.wood.id]: 50, [Resources.food.id]: 100}, {tier: GameTiers.overworked, upgrades: ['lucky-devil']}, {[Values.legendaryModifier]: 1.5, [Values.rareModifier]: 1.5, [Values.uncommonModifier]: 1.5}, undefined],
];
